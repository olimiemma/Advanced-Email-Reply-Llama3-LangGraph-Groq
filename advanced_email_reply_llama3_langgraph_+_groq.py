...
Original file is located at
    https://colab.research.google.com/drive/1SzpWIWLQgamJ5evtn9PdYJIgyaqfUs0T
"""
...
# os.environ['LANGCHAIN_ENDPOINT'] = 'https://api.olimi.langchain.com'
...
"""## Basic Chains ( For your specfic case,first write out your flow, diagram out what you want to do)
...
prompt = PromptTemplate(
    ...
    Conduct a comprehensive analysis of the email provided and categorize into one of the following categories:
        ...
        customer_complaint - used when someone is complaining about something or a prodcut\
...
class GraphState(TypedDict):
    """
    Represents the state of our graph. #variables we pass around
...
def route_to_rewrite(state):
    ...
    # draft_email = "Sorry we can't help you, best regards EKO"
...
# Define the nodes .You can start of with fewer nodeds.
...
workflow.add_conditional_edges(
    ...
    route_to_research,
    {
        "research_info": "research_info_search", #if it come back rese info -> to to res info
        "draft_email": "draft_email_writer", # if comes back draft email go to draft
    },
)
...
# run the agent
inputs = {"initial_email": EMAIL,"research_info": None, "num_steps":0} #Anything we need to set at the start , set here
